#!/bin/bash
#
# SeniorTalk 评估脚本启动器 - 修复版
# 使用用户主目录避免 /data 只读问题
#

SESSION_NAME="seniortalk_eval_fixed"
SCRIPT_PATH="/home/saisai/AD_predict/AD_predict/scripts/eval_seniortalk_available_models_fixed.py"
LOG_DIR="$HOME/AD_predict_logs"
LOG_FILE="$LOG_DIR/eval_seniortalk_$(date +%Y%m%d_%H%M%S).log"
...
echo "================================================"
echo "Starting SeniorTalk Evaluation (Fixed Version)"
echo "================================================"
echo ""
...
tmux send-keys -t $SESSION_NAME "echo ''" C-m
tmux send-keys -t $SESSION_NAME "echo '========================================'" C-m
tmux send-keys -t $SESSION_NAME "echo 'Starting evaluation...'" C-m
